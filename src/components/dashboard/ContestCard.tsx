...
import { Trophy, Calendar, Trash2, Globe, FileEdit, Sparkles } from "lucide-react";
...
export default function ContestCard({ contest, onDelete, onPublish }: ContestCardProps) {
