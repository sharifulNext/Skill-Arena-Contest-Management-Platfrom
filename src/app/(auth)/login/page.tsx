          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 px-5 outline-none focus:border-primary/50 focus:ring-4 focus:ring-primary/10"
              />
            ...
            {/* BUTTON */}
            <Button className="w-full py-7 rounded-2xl font-black text-lg bg-primary hover:bg-primary/90 text-white">
              LOG IN
            </Button>
          </form>
