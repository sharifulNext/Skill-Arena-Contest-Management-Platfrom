      ...
      <div className="hidden lg:flex flex-col justify-between p-16 bg-slate-50 border-r border-slate-100">
        ...
        <div>
          <h2 className="text-5xl md:text-6xl font-black mb-6 leading-tight tracking-tighter text-slate-900">
            Join the <br /> 
            <span className="text-primary italic">Global Arena.</span>
          </h2>
          <p className="text-slate-500 text-lg max-w-sm leading-relaxed">
            Register now to showcase your skills, compete with the best, and climb the real-time leaderboard.
          </p>
        </div>
      ...
      <div className="flex flex-col justify-center items-center p-8 md:p-16 relative bg-white">
        ...
        >
          <div className="text-center lg:text-left">
            <h1 className="text-3xl font-black tracking-tight mb-2 text-slate-900">Create Account</h1>
          ...
          <div className="space-y-4">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-[10px] uppercase tracking-[0.2em] font-black">
                <span className="bg-white px-4 text-slate-400">Or use social</span>
              </div>
            </div>
